...
SDL_DYNAPI_PROC(SDL_DisplayLink*,SDL_CreateDisplayLink,(SDL_Window *a,const SDL_DisplayLinkOptions *b),(a,b),return)
SDL_DYNAPI_PROC(bool,SDL_StartDisplayLink,(SDL_DisplayLink *a),(a),return)
SDL_DYNAPI_PROC(bool,SDL_StopDisplayLink,(SDL_DisplayLink *a),(a),return)
SDL_DYNAPI_PROC(void,SDL_DestroyDisplayLink,(SDL_DisplayLink *a),(a),)
SDL_DYNAPI_PROC(SDL_DisplayLinkID,SDL_GetDisplayLinkID,(SDL_DisplayLink *a),(a),return)
SDL_DYNAPI_PROC(SDL_Window*,SDL_GetDisplayLinkWindow,(SDL_DisplayLink *a),(a),return)
